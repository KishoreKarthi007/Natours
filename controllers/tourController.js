        ...
        },
        {
            $addFields: {
                ...
                startDate: {
                    $dateFromString: {
                        dateString: {
                            $arrayElemAt: [{ $split: ['$startDates', ','] }, 0],
                        }, // Get the date part before the comma
                    },
                },
            },
        },
...
exports.topFiveTours = (req, res, next) => {
    ...
    req.query.limit = '5';
    req.query.fields = 'name,ratingsAverage,duration,price';
    next();
};

// /tours-within/:distance/center/:latlng/unit/:unit
// /tours-within/200/center/32,-15/unit/mi
